    ...
    return ReactDOM.createPortal(
      <div className="modal" onClick={onClose}>
        ...
        >
          ...
          <h2 className="fs-13 text-center" style={{fontWeight:"300"}}>{selectedProject?.name}</h2>
          <h4 className="fs-10 text-center" style={{fontWeight:"100"}}>{selectedProject?.dateCreated}</h4>
          <br></br>
